# Summary PLAN-0008 — Enforce .brain bootstrap in AGENTS.md on install/update
...
- update.sh, setup.sh, tests/test-update.sh, .brain/plans/completed/PLAN-0008/, .brain/test-cases/completed/PLAN-0008/, .brain/summaries/completed/PLAN-0008.md, .brain/memory/decisions/2026-09-05-agents-bootstrap.md, state yamls.

## Important architectural decisions
- See plans/completed/PLAN-0008/DECISIONS.md (D1-D4): prepend priority, marker substring, no CLAUDE chaining, missing-file fallback chain.

## Tests executed + results
| TC | Result | Notes |
|---|---|---|
| TC-0009 bootstrap enforcement | PASSED | §10 4/4, manual repro idempotent + good-file untouched |
