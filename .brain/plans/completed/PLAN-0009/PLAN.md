# PLAN-0009 — Updater self-refresh for installed .ai/update.sh copies
...
## Problem
.ai/update.sh in consumer projects is a stale copy. Not in SYSTEM_FILES/AI_FILES, never refreshed. PLAN-0008 AGENTS.md repair logic sat on master while bench/backend kept running the old updater. Update reported no visible change.
...
## Tasks
See TASKS.md. Covering TC: TC-0010.

## Required test cases
See test-cases/completed/PLAN-0009/INDEX.md.
