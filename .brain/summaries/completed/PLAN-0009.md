# Summary PLAN-0009 — Updater self-refresh for installed copies
...
- update.sh, tests/test-update.sh, VERSION, CLAUDE.md, CLAUDE.install.md, README.md, setup.sh, .brain/plans/completed/PLAN-0009/, .brain/test-cases/completed/PLAN-0009/, .brain/summaries/completed/PLAN-0009.md, .brain/memory/decisions/2026-09-05-updater-self-refresh.md, state yamls.

## Important architectural decisions
- See plans/completed/PLAN-0009/DECISIONS.md (D1-D3): dedicated function over manifest, single .bak, cwd/workspace guards.

## Tests executed + results
| TC | Result | Notes |
|---|---|---|
| TC-0010 self-refresh | PASSED | §11 4/4 |
