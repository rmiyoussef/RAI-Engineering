# 2026-09-05-central-engineering-brain — Refactor .brain into Central Engineering Brain
...
|---|---|---|
| Data loss during moves | low | git mv only; zero-D validation (TC-03) |
| Stale references missed | medium | repo-wide grep TC + allowlist migration code |

## Tasks
See TASKS.md. Covering TCs: TC-01..TC-06.

## Required test cases
See test-cases/active/2026-09-05-central-engineering-brain/INDEX.md.
