# Summary PLAN-0007 — Mandatory RAI OS: safe update.sh, thin entrypoints, model neutrality
...
- `.brain/`: planning/→plans/ (git mv), ARCHITECTURE.md, INSTRUCTIONS.md, constitution/RULES.md (R9), CONSTRAINTS.md, 16 agents, 3 protocols, sessions/README, context/PROJECT+ENVIRONMENT, state/version (new), state/migrations.log (new), plans/active/PLAN-0007, test-cases/..., templates/plan.
...
- See plans/completed/PLAN-0007/DECISIONS.md (D1-D6): append-only history, TEST-PLAN vs TC split, manifest policy, update.sh ownership, R9 neutrality, uniform .ai policy.

## Tests executed + results
| TC | Result | Notes |
|---|---|---|
| TC-0001 suite green | PASSED | 53/53, exit 0 |
| TC-0002 fresh install | PASSED | version/manifest/log/mirror/symlink/gitignore |
| TC-0003 domain upgrade | PASSED | data preserved, backup verified |
| TC-0004 custom files safe | PASSED | hash-stable + .new |
| TC-0005 idempotency | PASSED | stable, no spam |
| TC-0006 merges + conflicts | PASSED | _imported, --check clean |
| TC-0007 entrypoints neutral | PASSED | thin, no model lock |
| TC-0008 plans mandatory | PASSED | thresholds, contract |
