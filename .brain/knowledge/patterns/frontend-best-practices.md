...
These rules live in `.brain/rules/<purpose>/` (tagged `domains: [frontend]`) and are loaded selectively by sub-task:

| Rule file | Loaded when |
|-----------|-------------|
| `rules/architecture/components.md` | Building or reviewing components |
| `rules/coding/state-management.md` | Managing state, contexts, side effects |
| `rules/performance/frontend.md` | Performance optimization, bundle analysis |
| `rules/coding/accessibility.md` | Building accessible UI, reviewing a11y |
| `rules/coding/styling.md` | CSS, theming, responsive design |
