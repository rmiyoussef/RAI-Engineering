# PLAN-0007 — Mandatory RAI OS: safe update.sh, thin entrypoints, model neutrality
...
## Relevant context
- context/PROJECT.md, ARCHITECTURE.md §§12-14, INSTRUCTIONS.md, plans/completed/PLAN-0006/ (prior refactor pattern)
...
## Technical approach
Mechanical rename (history: PLAN-0006 records kept append-only); authority-file sections; entrypoint thinning; update.sh fresh rewrite reusing proven v1→v2 map with merge-safe primitives; fixture-generated test suite in temp dirs.
...
## Tasks
See TASKS.md. Covering TCs: TC-0001..TC-0008.

## Required test cases
See test-cases/active/PLAN-0007/INDEX.md.
